...
{
    j = nlohmann::json{{"module", t.module_},  {"async_uuid", t.async_uuid_},     {"msg_uuid", t.msg_uuid_},
...
{
    static const std::unordered_set<std::string> set = {"module",       "async_uuid", "msg_uuid", "route",
